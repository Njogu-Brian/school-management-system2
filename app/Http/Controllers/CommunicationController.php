...
class CommunicationController extends Controller
{
    ...
    public function sendEmail(Request $request)
    {
        ...
        if ($useQueue) {
            ...
            $progressUrl = url('/communication/bulk-email-progress') . '?tracking_id=' . urlencode($trackingId) . '&total=' . count($recipients);
    ...
    public function sendSMS(Request $request, SMSService $smsService)
    {
        ...
        if ($useQueue) {
            ...
            $progressUrl = url('/communication/bulk-sms-progress') . '?tracking_id=' . urlencode($trackingId) . '&total=' . count($recipients);
