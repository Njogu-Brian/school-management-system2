...
class DirectoryExportService
{
  public function studentFieldGroups(): array
  {
    return [
      'Student' => [
        ...
        'knec_assessment_number' => 'KNEC Assessment / KCPE Index',
        ...
        'birth_certificate_entry_no' => 'Birth Certificate Entry No.',
        'religion' => 'Religion',
  ...
  public function extractStudentRow(Student $student, array $fields): array
  {
    ...
    $values = [
      ...
      'kcpe_kjsea_year' => $student->kcpe_kjsea_year,
      'nationality' => $student->nationality,
      'county_of_birth' => $student->county_of_birth,
      'sub_county_of_birth' => $student->sub_county_of_birth,
      'location_of_birth' => $student->location_of_birth,
      'birth_certificate_entry_no' => $student->birth_certificate_entry_no,
      'religion' => $student->religion,
      'medical_condition' => $student->medical_condition,
      'orphan_status' => $student->orphan_status,
      'learner_interests' => is_array($student->learner_interests) ? implode(', ', $student->learner_interests) : $student->learner_interests,
