  ...
  return (
    <section className="bg-gradient-to-b from-[#faf6ef] to-white py-12">
      <div className="mx-auto max-w-6xl px-4">
        ...
        <p className="mt-1 text-[#4a3a5c]">Noticeboard and lunch menu from Royal Kings</p>
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          <div className="rounded-2xl border border-[#e0d4f0] bg-white p-5 shadow-sm">
            ...
            {status?.current_term?.name && <p className="mt-2 text-sm">Term: {status.current_term.name}</p>}
          </div>
