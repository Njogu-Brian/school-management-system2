import { API_BASE_URL, useAuth, useBiometricAuth, useBranding } from '@erp/core';
...
export const LoginScreen: React.FC = () => {
  ...
  const bioFirst = unlockAvailable && !isLocked && !showCredentialForm;
    ...
    >
      ...
      {bioFirst ? (
        <>
          ...
          <Pressable
            onPress={() => setShowCredentialForm(true)}
