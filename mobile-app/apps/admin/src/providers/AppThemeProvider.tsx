...
const ThemedShell: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    ...
    >
      {/* Expose surface setter via React context would be ideal; SessionScreen uses ThemeProvider surfaceMode + local storage bridge */}
...
/** Lightweight context so Settings can toggle AMOLED without prop drilling. */
