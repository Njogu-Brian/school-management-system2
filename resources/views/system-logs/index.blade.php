...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <small class="text-muted">View application errors and system logs</small>
        </div>
        <div class="d-flex gap-2">
            <a href="{{ route('system-logs.download') }}" class="btn btn-outline-primary">
                <i class="bi bi-download"></i> Download Logs
            </a>
            <form action="{{ route('system-logs.clear') }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to clear all logs? This action cannot be undone.');">
                @csrf
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('system-logs.index') }}" class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="search" class="form-control" value="{{ $currentSearch ?? '' }}" placeholder="Search in messages and stack traces...">
                </div>
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-dark text-white">
            <div class="d-flex justify-content-between align-items-center">
                ...
                @if(isset($total))
                    <span class="badge bg-light text-dark">{{ $total }} entries found</span>
                @endif
            </div>
        </div>
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-primary" onclick="copyLogDetails({{ $loop->index }})">
