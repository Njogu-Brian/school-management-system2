        ...
        <div class="row g-3 mt-1">
          <div class="col-md-6">
            ...
            <select name="campus" class="form-select">
              ...
              <option value="upper" @selected(old('campus', $classroom->campus) === 'upper')>Upper Campus (Creche–Grade 3)</option>
              <option value="lower" @selected(old('campus', $classroom->campus) === 'lower')>Lower Campus (Grade 4–9)</option>
            </select>
          ...
          <div class="col-md-6">
            ...
            <select name="level_type" class="form-select">
              ...
              <option value="preschool" @selected(old('level_type', $classroom->level_type) === 'preschool')>Preschool</option>
              <option value="lower_primary" @selected(old('level_type', $classroom->level_type) === 'lower_primary')>Lower Primary (Grade 1–3)</option>
              <option value="upper_primary" @selected(old('level_type', $classroom->level_type) === 'upper_primary')>Upper Primary (Grade 4–6)</option>
              <option value="junior_high" @selected(old('level_type', $classroom->level_type) === 'junior_high')>Junior High (Grade 7–9)</option>
            </select>
          </div>
        </div>
