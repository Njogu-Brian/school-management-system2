...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">Edit Learning Area</h1>
            ...
            <form action="{{ route('academics.learning-areas.update', $learning_area) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('code') is-invalid @enderror" 
                               id="code" name="code" value="{{ old('code', $learning_area->code) }}" required>
                        @error('code')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" 
                               id="name" name="name" value="{{ old('name', $learning_area->name) }}" required>
                        @error('name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" 
                              id="description" name="description" rows="3">{{ old('description', $learning_area->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="row">
                        ...
                        <select class="form-select @error('level_category') is-invalid @enderror" 
                            ...
                            @foreach($levelCategories as $key => $category)
                                <option value="{{ $category }}" 
                                        {{ old('level_category', $learning_area->level_category) == $category ? 'selected' : '' }}>
                                    {{ $category }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-8 mb-3">
                        ...
                        <div class="row">
                            @php
                                $selectedLevels = old('levels', $learning_area->levels ?? []);
                            @endphp
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('display_order') is-invalid @enderror" 
                               ...
                               value="{{ old('display_order', $learning_area->display_order) }}" min="0">
                        @error('display_order')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="form-check mt-4">
                            <input class="form-check-input" type="checkbox" id="is_core" name="is_core" value="1" 
                                   {{ old('is_core', $learning_area->is_core) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="form-check mt-4">
                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" 
                                   {{ old('is_active', $learning_area->is_active) ? 'checked' : '' }}>
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-save"></i> Update Learning Area
                    </button>
                </div>
            </form>
        </div>
