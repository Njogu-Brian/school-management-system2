...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">My Timetable - {{ $teacher->full_name ?? $teacher->first_name . ' ' . $teacher->last_name }}</h1>
        <div class="btn-group">
    ...
    <div class="alert alert-info">
        <i class="bi bi-info-circle"></i> No timetable found for this teacher. Please generate a timetable first.
    </div>
    @endif
</div>
@endsection
