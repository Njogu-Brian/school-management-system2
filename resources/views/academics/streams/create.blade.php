...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <small class="text-muted">Create a new stream and assign it to classrooms</small>
        </div>
        ...
        <div class="card-body">
            <form action="{{ route('academics.streams.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <small class="text-muted">Select additional classrooms this stream should be available in</small>
                </div>
