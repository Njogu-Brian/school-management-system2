...
<div class="container-fluid">
  <div class="d-flex align-items-center justify-content-between mb-4">
    <div>
      <h2 class="mb-0">Custom Deductions</h2>
      <small class="text-muted">Manage staff custom deductions</small>
    </div>
    <a href="{{ route('hr.payroll.custom-deductions.create') }}" class="btn btn-primary">
          ...
          <tbody>
            @forelse($deductions as $deduction)
              <tr>
                ...
                <td>
                  <span class="badge bg-primary">{{ $deduction->deductionType->name }}</span>
                </td>
                <td>
                ...
                <td>
                  ...
                  @endphp
                  <span class="badge bg-{{ $badge }}">{{ ucfirst($deduction->status) }}</span>
                </td>
                <td class="text-end">
                  <div class="btn-group" role="group">
                    <a href="{{ route('hr.payroll.custom-deductions.show', $deduction->id) }}" class="btn btn-sm btn-outline-info" title="View">
                      <i class="bi bi-eye"></i>
                    </a>
                    @if($deduction->status === 'active')
                      <a href="{{ route('hr.payroll.custom-deductions.edit', $deduction->id) }}" class="btn btn-sm btn-outline-primary" title="Edit">
