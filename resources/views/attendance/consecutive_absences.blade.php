  ...
  <div class="settings-shell">
    <div class="page-header d-flex justify-content-between align-items-start flex-wrap gap-3">
      <div>
        ...
        <h1 class="mb-1">Consecutive Absences</h1>
        <p class="text-muted mb-0">Students with multiple consecutive days of absence.</p>
      </div>
    ...
    <div class="settings-card mb-3">
      <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
        <div>
          ...
          <p class="text-muted small mb-0">Class, stream, and minimum days.</p>
        </div>
    ...
    <div class="settings-card">
      <div class="card-header bg-danger text-white d-flex justify-content-between align-items-center">
        ...
        <span class="pill-badge pill-light">Alert list</span>
      </div>
              ...
              @foreach($students as $index => $item)
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <span class="pill-badge pill-danger fs-6">{{ $consecutive }} day(s)</span>
                  </td>
                  <td>
                    @if($student->parent)
                      <div class="small">
                  ...
                  <td class="text-end">
                    ...
                    <a href="{{ route('students.show', $student) }}" class="btn btn-sm btn-ghost-strong">
