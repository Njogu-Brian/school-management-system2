    ...
    <div class="settings-shell">
        <div class="page-header d-flex justify-content-between align-items-start flex-wrap gap-3">
            <div>
                ...
                <p>Specify what each learner should provide at the beginning of the term.</p>
            </div>
        ...
        <div class="settings-card">
            <div class="card-body">
                <form method="POST" action="{{ route('inventory.requirement-templates.store') }}" class="row g-3">
                    @csrf
                    <div class="col-md-6">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="term_id" class="form-select" id="termSelect" data-selected="{{ old('term_id') }}">
                            <option value="">Any</option>
                        </select>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-6">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="leaveWithTeacher">
                                Collect into school inventory (school property)
                            </label>
                        </div>
                        <div class="form-check mt-2">
                            ...
                            <label class="form-check-label" for="verificationOnly">
                                Verify only — learner keeps it (not school stock)
                            </label>
                        </div>
                        <small class="text-muted d-block mt-1">If you later switch Collect to Verify, quantities already taken into inventory from learners are removed from school stock.</small>
                    </div>
                    <div class="col-md-6">
