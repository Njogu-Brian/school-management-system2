                    ...
                    <div class="message-area">
                        @if($channel === 'whatsapp')
                            <div class="message-bubble sent">
                                <div class="message-content">{!! preg_replace('/(https?:\/\/[^\s<]*[^\s<.,;:!?)\]}])/', '<a href="$1" class="message-link" target="_blank">$1</a>', nl2br(e($message))) !!}</div>
                        ...
                        @elseif($channel === 'email')
                            <div class="email-content">
                                ...
                                <div class="email-body">{!! preg_replace('/(https?:\/\/[^\s<]*[^\s<.,;:!?)\]}])/', '<a href="$1" class="message-link" target="_blank">$1</a>', nl2br(e($message))) !!}</div>
                            </div>
                        @else
                            <div class="sms-message">
                                ...
                                <div class="sms-body">{!! preg_replace('/(https?:\/\/[^\s<]*[^\s<.,;:!?)\]}])/', '<a href="$1" class="message-link" target="_blank">$1</a>', nl2br(e($message))) !!}</div>
                            </div>
                        @endif
                    </div>
