        ...
        <div class="table-responsive">
          <table class="table table-modern align-middle mb-0">
            ...
            <tbody>
              ...
              @empty
                <tr>
                  <td colspan="5" class="text-center text-muted py-4">No families found.</td>
                </tr>
              @endforelse
            </tbody>
          </table>
            ...
            <tbody>
              @forelse($audits as $audit)
                <tr>
                  ...
                  <td class="text-muted small">{{ $audit->source }}</td>
                </tr>
              @empty
                <tr>
                  <td colspan="7" class="text-center text-muted py-4">No updates recorded yet.</td>
                </tr>
              @endforelse
            </tbody>
          </table>
