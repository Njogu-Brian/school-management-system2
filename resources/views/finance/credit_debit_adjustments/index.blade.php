...
<div class="finance-page">
  <div class="finance-shell">
    @include('finance.partials.header', [
        ...
        'actions' => '<a href="' . route('finance.student-credit-debit-notes.index') . '" class="btn btn-finance btn-finance-outline me-2"><i class="bi bi-file-earmark-spreadsheet"></i> Export School</a> <a href="' . route('finance.journals.create') . '" class="btn btn-finance btn-finance-primary"><i class="bi bi-plus-circle"></i> New Adjustment</a> <a href="' . route('finance.journals.bulk.form') . '" class="btn btn-finance btn-finance-outline"><i class="bi bi-upload"></i> Bulk Import</a>'
    ])
