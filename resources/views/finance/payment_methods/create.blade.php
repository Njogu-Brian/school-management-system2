...
<div class="container-fluid">
    ...
    <div class="finance-card finance-animate">
        ...
        <div class="finance-card-body">
            <form method="POST" action="{{ route('finance.payment-methods.store') }}">
                @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('code') }}" 
                               placeholder="e.g., CASH, MPESA, BANK_TRANSFER"
                               required>
                    ...
                    <div class="col-md-12">
                        <div class="form-check">
                            ...
                            <small class="form-text text-muted d-block">Check if this payment method requires a transaction reference (e.g., M-Pesa, Bank Transfer)</small>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-check">
                            ...
                            <small class="form-text text-muted d-block">Check if this is an online payment method (e.g., M-Pesa, Stripe, PayPal)</small>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-finance btn-finance-primary">
                                <i class="bi bi-check-circle"></i> Create Payment Method
                            </button>
                        </div>
                    </div>
                </div>
