...
<div class="finance-page">
  <div class="finance-shell">
    <div class="finance-card finance-animate mb-3 d-flex justify-content-between align-items-center p-3">
        <h1 class="h4 mb-0">Schedule Custom Fee Communication</h1>
    ...
    <div class="finance-card finance-animate">
        <div class="finance-card-body">
            <form action="{{ route('finance.fee-reminders.schedule.store') }}" method="POST" id="scheduleFeeForm">
                ...
                <div class="row mb-3 target-field target-one_parent d-none">
                    <div class="col-md-6">
                ...
                <div class="row mb-3 target-field target-specific_students d-none">
                    <div class="col-md-12">
                ...
                <div class="row mb-3 target-field target-class d-none">
                    <div class="col-md-6">
                        <label class="form-label">Classroom(s) <span class="text-danger">*</span></label>
                ...
                {{-- Filter by fee type --}}
                <h5 class="mb-3 mt-4">Filter by fee type</h5>
                <div class="row mb-3">
                    <div class="col-md-12">
                        <div class="d-flex gap-3 flex-wrap">
                            <div class="form-check">
                ...
                <div class="row mb-3 balance-criteria balance-outstanding balance-swimming d-none">
                    <div class="col-md-4">
                        <label class="form-label">Balance >= KES</label>
                        <input type="number" name="balance_min" class="form-control" value="{{ old('balance_min') }}" min="0" step="0.01" placeholder="Optional">
                    </div>
                    <div class="col-md-4 balance-outstanding balance-percent d-none">
                        <label class="form-label">Unpaid % of term fees >=</label>
                        <input type="number" name="balance_percent_min" class="form-control" value="{{ old('balance_percent_min') }}" min="0" max="100" step="0.01" placeholder="Optional">
                    </div>
                </div>

                {{-- Channels --}}
                <h5 class="mb-3 mt-4">Channels <span class="text-danger">*</span></h5>
                <div class="row mb-3">
                    <div class="col-md-12">
                        <div class="d-flex gap-3 flex-wrap">
                            <div class="form-check">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="datetime-local" name="send_at" class="form-control" value="{{ old('send_at') }}" required min="{{ now()->addMinute()->format('Y-m-d\TH:i') }}">
                        <small class="text-muted">Message will be sent automatically at the scheduled time.</small>
                        @error('send_at')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        <button type="button" class="btn btn-outline-secondary" id="previewCountBtn">
                ...
                <div class="d-flex justify-content-end gap-2 mt-4">
                    ...
                    <button type="submit" class="btn btn-finance btn-finance-primary">Schedule Communication</button>
                </div>
            </form>
        </div>
    </div>
