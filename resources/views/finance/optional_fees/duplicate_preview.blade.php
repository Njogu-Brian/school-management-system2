...
<div class="finance-page">
  <div class="finance-shell">
    @include('finance.partials.header', [
        'title' => 'Duplicate Optional Fees – Preview',
        'icon' => 'bi bi-copy',
        ...
        <div class="row g-3">
          ...
          <div class="col-12">
            <p class="text-muted small mb-0">
              <i class="bi bi-check2-square"></i> Check items to approve. Uncheck to reject – rejected items will not be duplicated and will not appear in invoices. You can bill or exempt them later from the student view.
            </p>
          </div>
        </div>
      </div>
    ...
    <form method="POST" action="{{ route('finance.optional_fees.duplicate.commit') }}">
      @csrf
      ...
      <div class="finance-card finance-animate shadow-sm rounded-4 border-0 mb-4">
        <div class="finance-card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
          <span><i class="bi bi-list-check me-2"></i>Proposed optional fees ({{ count($items) }})</span>
        ...
        <div class="finance-card-body border-top d-flex flex-wrap gap-2 align-items-center">
          ...
          <a href="{{ route('finance.optional_fees.index') }}" class="btn btn-outline-secondary">Cancel</a>
