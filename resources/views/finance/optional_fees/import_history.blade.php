...
@section('content')
  @include('finance.partials.header', [
      'title' => 'Optional Fee Import History',
      'icon' => 'bi bi-clock-history',
      'subtitle' => 'View all optional fee imports and their details',
      'actions' => '<a href="' . route('finance.optional_fees.index') . '" class="btn btn-finance btn-finance-outline"><i class="bi bi-arrow-left"></i> Back to Optional Fees</a>'
  ])
    ...
    <div class="finance-card-body p-4">
      <form method="GET" class="row g-3">
        ...
        <div class="col-md-3 d-flex align-items-end">
          ...
          @if($year || $term)
            <a href="{{ route('finance.optional-fees.import-history') }}" class="btn btn-outline-secondary ms-2">
            ...
            <tr>
              ...
              <td>
                <div class="d-flex gap-2">
                  <a href="{{ route('finance.optional-fees.import-details', $import) }}" class="btn btn-sm btn-outline-primary">
