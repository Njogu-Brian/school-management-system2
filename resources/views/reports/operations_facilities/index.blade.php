  ...
  <div class="settings-shell">
    <div class="page-header d-flex justify-content-between align-items-start flex-wrap gap-3">
      <div>
        ...
        <h1 class="mb-1">Operations & Facilities</h1>
      ...
      <div class="d-flex gap-2 flex-wrap">
        ...
        <a href="{{ route('reports.operations-facilities.create') }}" class="btn btn-settings-primary">
    ...
    <div class="settings-card">
      <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
        <div>
          <h5 class="mb-0"><i class="bi bi-building-gear"></i> Operations & Facilities</h5>
          <p class="text-muted small mb-0">Week ending, campus, area, status and resolution.</p>
        </div>
