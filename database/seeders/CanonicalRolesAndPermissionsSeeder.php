...
class CanonicalRolesAndPermissionsSeeder extends Seeder
{
    ...
    private function portalPermissions(): array
    {
        return [
            ...
            'communication.send_email', 'communication.send_sms', 'communication.send_whatsapp', 'communication.logs',
            'communication.email.add', 'communication.sms.add', 'communication.whatsapp.add',
    ...
    private function secretaryPermissions(): array
    {
        return array_values(array_unique(array_merge(
            [
                ...
                'communication.send_whatsapp', 'communication.email.add', 'communication.sms.add', 'communication.whatsapp.add',
